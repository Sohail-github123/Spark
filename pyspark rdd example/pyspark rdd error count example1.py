...
if __name__ == "__main__":
    print("Apache Spark Application - YARN Log File - Starts Here ...")
    ...
    spark = SparkSession \
        .builder \
        .appName("Apache Spark Application using  - YARN Log File - Demo") \
        .master("local[*]") \
        .getOrCreate()
    ...
    print("Apache Spark Application using  - YARN Log File - Ends Here.")
    print(time.strftime("%Y-%m-%d %H:%M:%S"))